...
type Module struct {
	...
	ModuleRuntime int32     `json:"module_duration,omitempty"`
...
func ValidateModule(v *validator.Validator, module *Module) {
	...
	v.Check(module.ModuleRuntime != 0, "module_duration", "must be provided")
	v.Check(module.ModuleRuntime > 0, "module_duration", "must be a positive integer")
...
RETURNING id, created_at, updated_at, version`
	...
	args := []any{module.ModuleName, module.ModuleRuntime, pq.Array(module.ExamType)}
